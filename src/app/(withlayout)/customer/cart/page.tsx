      ...
      <div className="flex shadow-md my-10">
        <div className="w-3/4 bg-white px-10 py-10">
          ...
          <div className="flex mt-10 mb-5">
            ...
            <h3 className="font-semibol text-gray-600 text-xs uppercase w-1/5 text-center">
              Price
            </h3>
            <h3 className="font-semibold text-gray-600 text-xs uppercase w-1/5 text-center">
              Total
        ...
        <div id="summary" className="w-1/4 px-8 py-10">
          ...
          <div className="border-t mt-8">
            <div className="flex font-semibold font-semibold justify-between py-6 text-sm uppercase">
              <span>Total cost</span>
              <span>$600</span>
            </div>
            <button className="bg-[#fd4f1a] outline-none border-none font-semibold py-3 text-sm text-white uppercase w-full">
              Book Now
            </button>
          </div>
        </div>
