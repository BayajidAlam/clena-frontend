    ...
    >
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 lg:grid-cols-4 items-center gap-6">
        ...
        <div className="space-y-4 text-center">
          ...
          <p>
            A money-back guarantee, also known as a satisfaction guarantee, if a
            buyer is not satisfied with a product or service.
          </p>
        </div>
        <div className="space-y-4 text-center">
          <div className="text-5xl text-[#ff5100]">
          ...
          <p>
            Because indoor pollution rates are typically higher than outdoor
            pollution rates, we take dust removal seriously.
          </p>
        </div>
        <div className="space-y-4 text-center">
          <div className="text-5xl text-[#ff5100]">
          ...
          <p>
            Precision cleaning is required throughout such a broad range of
            modern industries that it might be more.
          </p>
        </div>
      </div>
    </div>
